...
public class RecyclerViewLoadMoreWidget  implements RVLoadMoreHelper.LoadMoreController,LoadMoreWidget {
    ...
    public RecyclerViewLoadMoreWidget(RecyclerView mRecyclerView) {
