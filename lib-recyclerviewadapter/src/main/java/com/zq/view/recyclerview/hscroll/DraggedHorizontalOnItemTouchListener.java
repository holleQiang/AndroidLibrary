...
class DraggedHorizontalOnItemTouchListener implements RecyclerView.OnItemTouchListener, Runnable {
    ...
    DraggedHorizontalOnItemTouchListener(RecyclerView recyclerView, ScrollableRecyclerViewGetter<RVViewHolder> recyclerViewGetter) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if(childView != null){
                    ...
                    shouldChildIntercept = recyclerViewGetter.getScrollableRecyclerView(viewHolder) != null;
                }
    ...
    private void childRecyclerViewScrollBy(int deltaX) {
        ...
        for (int j = 0; j < childCount; j++) {
            ...
            RVViewHolder viewHolder = (RVViewHolder) recyclerView.getChildViewHolder(childView);
            RecyclerView recyclerView1 = recyclerViewGetter.getScrollableRecyclerView(viewHolder);
            if (recyclerView1 != null) {
                recyclerView1.scrollBy(deltaX, 0);
            }
        }
    }
